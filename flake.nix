{
  ...
  inputs = {
    ...
    # Waiting for tailscale fix to be merged https://github.com/NixOS/nixpkgs/pull/437536
    # Waiting for tkinter fix to be merged https://github.com/NixOS/nixpkgs/pull/442184
